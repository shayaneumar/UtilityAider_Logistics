<!DOCTYPE html><html lang="en">
    ...
    <body style="background-color:#E6E6E6"class="guest v2 new-ghome login-in-header chrome-v5 chrome-v5-responsive sticky-bg guest" >
        ...
        <div class="container-fluid" >
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <div class="nav navbar-nav" >
                    ...
                    <li style="left:60px;width:100px"><a href="viewpost" style="width:80px"><font style="font-weight:600;font-family:'Open Sans','Helvetica Neue','Helvetica','Arial','sans-serif';" size="3">Trucks</font></a></li>
                ...
                <table class="table table-striped " >
                    ...
                    <tbody>
                        <tr>
                            <td>Ahmedabad</td>
                            <td>Delhi</td>
                            <td ><font size="2">Iron</font></td>
                            <td>8</td>
                            <td><font size="2">22/08/2016</font></td>
                            <td><div id="wrapper"><div class="leo-module mod-feat jointoday" >
                                        <button type="submit"  onmousedown="toggleOverlay3()"name="" value="Respond" style="height:20px;width:70px;margin-top:0px;line-height:14px;font-size:13px"id="btn-submit" class="btn-action" tabindex="9"><font face="Open Sans" style="font-weight:normal;font-size:13px">Respond</font></button>
                                    </div></div>
                            </td>
                        </tr>
                        <tr>
        ...
        <script>$(document).ready(function () {
            ...
            $this.text($(this).is(':visible') ? 'Close' : 'Respond');
            });
            });
                    });</script>	
        ...
        <div id="mypostpostgoods" class="col-md-0 col-md-offset-3" style=";display:none;width:50%;margin-right:0px;height:100px">
            <div style="background-color:#d8d8d8;height:10%">
                    ...
                    <div class="content"style="margin-left:0px">		<table class="table table-striped " >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Ahmedabad</td>
                                    <td>Delhi</td>
                                    <td><img src="images/trucklogo1.png" style="height:15px;width:15px;"></img>&nbsp&nbspTruck B</td>
                                    <td ><font size="2"><img src="images/driver1.png" style="height:15px;width:15px;"></img>&nbsp&nbspDriver B</font></td>
                                    <td>Rs. 25000</td>
                                    <td><div class="leo-module mod-feat jointoday" >
                                            <button type="submit" href="#modal-dialogConfirm"  data-toggle="modal"value="Confirm" style="height:20px;width:70px;margin-top:0px;line-height:14px;font-size:13px"id="btn-submit" class="btn-action" tabindex="9"><font face="Open Sans" style="font-weight:normal">Confirm</font></button>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>Delhi</td>
                                    <td><img src="images/trucklogo1.png" style="height:15px;width:15px;"></img>&nbsp&nbspTruck B</td>
                                    <td ><font size="2"><img src="images/driver1.png" style="height:15px;width:15px;"></img>&nbsp&nbspDriver C</font></td>
                                    <td>Rs. 25000</td>
                                    <td><div class="leo-module mod-feat jointoday" >
                                            <button type="submit"  href="#modal-dialogConfirm"  data-toggle="modal" value="Confirm" style="height:20px;width:70px;margin-top:0px;line-height:14px;font-size:13px"id="btn-submit" class="btn-action" tabindex="9"><font face="Open Sans" style="font-weight:normal">Confirm</font></button>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>Delhi</td>
                                    <td><img src="images/trucklogo1.png" style="height:15px;width:15px;"></img>&nbsp&nbspTruck B</td>
                                    <td ><font size="2"><img src="images/driver1.png" style="height:15px;width:15px;"></img>&nbsp&nbspDriver D</font></td>
                                    <td>Rs. 25000</td>
                                    <td><div class="leo-module mod-feat jointoday" >
                                            <button type="submit" href="#modal-dialogConfirm"  data-toggle="modal"value="Confirm" style="height:20px;width:70px;margin-top:0px;line-height:14px;font-size:13px"id="btn-submit" class="btn-action" tabindex="9"><font face="Open Sans" style="font-weight:normal">Confirm</font></button>
                                        </div>
                ...
                <div class="leo-module mod-feat jointoday" >
                    ...
                    <button class="btn-action" style="margin-top:-3%;margin-left:89.5%;height:20px;width:70px;margin-top:0px;line-height:14px;font-size:13px;font-weight:normal">Respond</button>
                </div>
            </div>
